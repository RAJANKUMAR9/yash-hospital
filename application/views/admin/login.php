...
<head>
	...
	<title>Yash Hospital Login</title>

	<!-- <link rel="canonical" href="pages-sign-in.html" /> -->
	<link rel="shortcut icon" href="<?php echo base_url(); ?>public/admin/imgs/icon.jpg">
	...
	<link href="<?php echo base_url(); ?>public/admin/css/light.css" rel="stylesheet">
								...
								<div class="card-body">
									<div class="m-sm-4">
										<div class="text-center">
											<img src="<?php echo base_url(); ?>public/admin/img/avatars/avatar.jpg" alt="Chris Wood" class="img-fluid rounded-circle" width="132" height="132" />
										</div>
